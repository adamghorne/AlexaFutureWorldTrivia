...
var GAME_LENGTH = 4;  // The number of questions per trivia game.
var GAME_STATES = {
...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Future World Trivia", // Be sure to change this for your skill.
            "HELP_MESSAGE": "I will ask you %s questions about the future. Channel your third eye and you will find the answer. I can see the future so I already know you can. " +
            "To answer, say one, two or three. Never scream. Never tear up. And never cry about this future. For it can not be changed. Ohh, but you can start a new game by saying, start game. ",
            "REPEAT_QUESTION_MESSAGE": "You can say repeat at any time. ",
            "ASK_MESSAGE_START": "Want to start now?",
            "HELP_REPROMPT": "Hey. It is easy. To give an answer to a question, respond with the number of the answer. ",
            "STOP_MESSAGE": "Want to keep going?",
            "CANCEL_MESSAGE": "Ok, let\'s play again soon.",
            "NO_MESSAGE": "Ok, we\'ll do this another time. The future never sleeps. Goodbye!",
            "TRIVIA_UNHANDLED": "Try guessing a number between 1 and %s",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the game.",
            "START_UNHANDLED": "Say start to start a new game.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "Hi. I've returned from the future, to test you on history that hasn't even happened yet. I will ask  %s questions about a future you simply wouldn't believe. Seriously, it's nuts. Crazy neon cyborg robotic over lord nuts. " +
            "Just say the number of your answer. ",
            "ANSWER_CORRECT_MESSAGE": "Correct. ",
            "ANSWER_WRONG_MESSAGE": "Wrong. ",
            "CORRECT_ANSWER_MESSAGE": "The answer is %s: %s. ",
            "ANSWER_IS_MESSAGE": "That answer is ",
            "TELL_QUESTION_MESSAGE": "Question %s. %s ",
            "GAME_OVER_MESSAGE": "You got %s out of %s questions correct. Thanks for hanging out in the future!",
